...
export function QuoteItemsTable({ items, onItemsChange, validUntil, onValidUntilChange }: QuoteItemsTableProps) {
  const [draggedIndex, setDraggedIndex] = useState<number | null>(null)
  const [dragOverIndex, setDragOverIndex] = useState<number | null>(null)
  
  // 날짜 텍스트 클릭 시 달력 열기
  const handleDateTextClick = () => {
    const dateInput = document.getElementById('validUntilDate') as HTMLInputElement
    if (dateInput) {
