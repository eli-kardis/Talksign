-- Complete Enhanced Contracts Setup for LinkFlow - Single Script
...
-- ================================
-- PART 5: CLEAR EXISTING DATA AND INSERT SAMPLES
-- ================================

-- Clear existing contract-related data to avoid conflicts
TRUNCATE public.contract_activities CASCADE;
TRUNCATE public.contract_terms CASCADE;
TRUNCATE public.contract_items CASCADE;
DELETE FROM public.contracts WHERE id LIKE '770e8400-%';
DELETE FROM public.quotes WHERE id LIKE '660e8400-%';
...
-- ================================
-- PART 7: ENABLE RLS AND PERMISSIONS
-- ================================
