...
INSERT INTO customers (company_name, representative_name, contact_person, business_registration_number, email, phone, address) VALUES
('(주)스타트업에이', '김사장', '이담당', '123-45-67890', 'contact@startup-a.com', '02-1234-5678', '서울시 강남구 테헤란로 123, 스타트업타워 5층'),
('테크솔루션즈', '박대표', '최매니저', '234-56-78901', 'info@techsolutions.com', '02-9876-5432', '서울시 서초구 강남대로 456, 테크빌딩 10층'),
('디자인스튜디오', '정실장', NULL, NULL, 'hello@designstudio.co.kr', '010-1111-2222', '서울시 마포구 홍대입구로 789, 크리에이티브센터 3층'),
('글로벌인더스트리', '송회장', '윤과장', '345-67-89012', 'business@global-industry.com', '02-5555-6666', '부산시 해운대구 센텀중앙로 100, 글로벌타워 20층'),
('스마트솔루션', '한이사', '신차장', '456-78-90123', 'contact@smart-sol.kr', '031-7777-8888', '경기도 성남시 분당구 판교로 200, 스마트빌딩 7층'),
('클라우드테크', '조대표', '김팀장', '567-89-01234', 'admin@cloudtech.co.kr', '02-3333-4444', '서울시 영등포구 여의도동 국제금융로 10, 클라우드센터 15층'),
('이노베이션랩', '이사장', NULL, NULL, 'contact@innovation-lab.com', '010-5555-7777', '대전시 유성구 대학로 291, 이노베이션빌딩 8층'),
('미래기술', '최회장', '박부장', '678-90-12345', 'info@futuretech.kr', '051-9999-8888', '부산시 남구 용소로 45, 미래기술타워 12층')
...
COMMENT ON COLUMN customers.business_registration_number IS 'Business registration number (optional)';
